 ...
 * DO NOT EDIT!!
 *
 * REQUIRED MEMORY: 4528+(2688*2)+(1088*2) = 12080 Bytes
 */
...
static const SBUInt8 PrimaryBidiTypeData[4528] = {
...
/* DATA_BLOCK: -- 0x02B0..0x02BF -- */
    AN,  AN,  AL,  AL,  AL,  AL,  AL,  AL,  NSM, NSM, NSM, NSM, NSM, NSM, NSM, NSM,
...
/* DATA_BLOCK: -- 0x1140..0x114F -- */
    ON,  ON,  ON,  ON,  ON,  ON,  ON,  ON,  L,   L,   L,   L,   L,   ON,  ON,  ON,
...
/* DATA_BLOCK: -- 0x1170..0x117F -- */
    ON,  ON,  ON,  ON,  ON,  L,   L,   L,   ON,  ON,  ON,  ON,  ON,  L,   L,   L,
...
static const SBUInt16 MainBidiTypeIndexes[2688] = {
...
/* INDEX_BLOCK: -- 0x0240..0x027F -- */
    0x0100, 0x0100, 0x08E0, 0x00B0, 0x08F0, 0x00B0, 0x0100, 0x0100, 0x0900, 0x0910, 0x00B0, 0x00B0,
...
/* INDEX_BLOCK: -- 0x0280..0x02BF -- */
    ...
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0940, 0x0100, 0x0950, 0x0100, 0x0100,
    0x0100, 0x0100, 0x0100, 0x0100,
/* INDEX_BLOCK: -- 0x02C0..0x02FF -- */
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x0960, 0x0970, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0980,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0110, 0x0110, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x0990, 0x00B0, 0x00B0, 0x0100, 0x09A0, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x09B0,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x08C0, 0x00B0, 0x09C0,
/* INDEX_BLOCK: -- 0x0300..0x033F -- */
    0x09D0, 0x0100, 0x09E0, 0x09F0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0A00, 0x0040, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x0A10, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0100, 0x0100, 0x09B0, 0x00B0, 0x00B0, 0x07B0, 0x00B0, 0x00B0,
    0x00B0, 0x0100, 0x00B0, 0x0A20, 0x00B0, 0x00B0, 0x00B0, 0x0A30, 0x0A40, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0A50, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x0680, 0x00B0, 0x0A60,
...
/* INDEX_BLOCK: -- 0x03C0..0x03FF -- */
    ...
    0x08E0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x07A0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x0980, 0x0A70, 0x00B0, 0x0A80, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0460,
...
/* INDEX_BLOCK: -- 0x04C0..0x04FF -- */
    ...
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0C70, 0x0910,
...
/* INDEX_BLOCK: -- 0x0540..0x057F -- */
    0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01D0, 0x01D0, 0x0CE0, 0x0CF0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x0D00, 0x0D10, 0x01A0, 0x01A0, 0x0D20, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01D0, 0x0250, 0x0200, 0x01D0, 0x01A0, 0x0D30, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01A0,
/* INDEX_BLOCK: -- 0x0580..0x05BF -- */
    0x0330, 0x00B0, 0x00B0, 0x0D40, 0x0D50, 0x00E0, 0x08C0, 0x0D60, 0x0460, 0x00B0, 0x00B0, 0x0D70,
    0x03E0, 0x00B0, 0x00B0, 0x00B0, 0x02E0, 0x00B0, 0x0D80, 0x0D90, 0x00B0, 0x00B0, 0x00B0, 0x0DA0,
    0x0460, 0x00B0, 0x00B0, 0x0DB0, 0x0DC0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0980, 0x0DD0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0980, 0x0DE0, 0x00B0,
    0x0460, 0x00B0, 0x00B0, 0x0470, 0x0580, 0x00B0, 0x0DF0, 0x0D90, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0,
/* INDEX_BLOCK: -- 0x05C0..0x05FF -- */
    0x00B0, 0x00B0, 0x00B0, 0x0D40, 0x0490, 0x0E00, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0E10,
    0x0E20, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x0E30, 0x0580, 0x0450, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0E40,
    0x0580, 0x00B0, 0x0C60, 0x00B0, 0x00B0, 0x00B0, 0x0E50, 0x0E60, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x0550, 0x0E70, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0,
/* INDEX_BLOCK: -- 0x0600..0x063F -- */
    0x00B0, 0x00B0, 0x0980, 0x0E80, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0E90, 0x0DA0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0EA0, 0x0580, 0x00B0, 0x0EB0, 0x00B0, 0x00B0, 0x0EC0,
    0x0ED0, 0x0EE0, 0x00B0, 0x00B0, 0x0EF0, 0x0F00, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0,
/* INDEX_BLOCK: -- 0x0640..0x067F -- */
    0x00B0, 0x00B0, 0x00B0, 0x0F10, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0F20, 0x0F30, 0x0F40,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0F50, 0x0E60, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x0F60, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0F70,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x0F80, 0x0F90, 0x0A90,
/* INDEX_BLOCK: -- 0x0680..0x06BF -- */
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0D90,
...
/* INDEX_BLOCK: -- 0x06C0..0x06FF -- */
    ...
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0980, 0x00B0, 0x00B0, 0x00B0, 0x0980, 0x02E0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x0FA0, 0x00B0,
/* INDEX_BLOCK: -- 0x0700..0x073F -- */
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0FB0, 0x0FC0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
...
/* INDEX_BLOCK: -- 0x0740..0x077F -- */
    ...
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x0110, 0x0110, 0x0FD0, 0x0110, 0x0D50, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0,
/* INDEX_BLOCK: -- 0x0780..0x07BF -- */
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0FE0, 0x0FF0,
    0x1000, 0x00B0, 0x1010, 0x00B0, 0x00B0, 0x00B0, 0x00D0, 0x00B0, 0x0100, 0x0100, 0x0100, 0x0100,
    0x1020, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x08E0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0,
/* INDEX_BLOCK: -- 0x07C0..0x07FF -- */
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0A10, 0x00B0, 0x00B0,
    0x00B0, 0x1030, 0x00B0, 0x00B0, 0x0A60, 0x00B0, 0x00B0, 0x00B0, 0x1040, 0x00B0, 0x00B0, 0x00B0,
    0x1050, 0x1060, 0x1060, 0x1060,
/* INDEX_BLOCK: -- 0x0800..0x083F -- */
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0110, 0x0110, 0x0110, 0x1070,
    0x0110, 0x0110, 0x0530, 0x0B40, 0x1080, 0x0700, 0x1090, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0,
/* INDEX_BLOCK: -- 0x0840..0x087F -- */
    0x10A0, 0x10B0, 0x10C0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0D50, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0E00, 0x00B0, 0x00B0, 0x00B0, 0x0730, 0x10D0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
    0x00B0, 0x00B0, 0x00B0, 0x00B0,
/* INDEX_BLOCK: -- 0x0880..0x08BF -- */
    0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x10E0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x10F0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01A0,
/* INDEX_BLOCK: -- 0x08C0..0x08FF -- */
    ...
    0x01D0, 0x01D0, 0x01D0, 0x01D0, 0x01D0, 0x01D0, 0x01D0, 0x01D0, 0x01D0, 0x01D0, 0x01D0, 0x1100,
    0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0, 0x01A0,
    0x01A0, 0x01A0, 0x01A0, 0x01A0,
/* INDEX_BLOCK: -- 0x0900..0x093F -- */
    0x0100, 0x0100, 0x09C0, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x09B0, 0x1110, 0x0A30,
    0x0A30, 0x0A30, 0x0100, 0x08C0, 0x1120, 0x00B0, 0x0A60, 0x00B0, 0x00B0, 0x00B0, 0x0920, 0x00B0,
    0x00B0, 0x00B0, 0x1130, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x00B0,
...
/* INDEX_BLOCK: -- 0x0940..0x097F -- */
    ...
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x1140, 0x0C60, 0x0C60,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x09B0, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x1150, 0x09C0, 0x0040,
/* INDEX_BLOCK: -- 0x0980..0x09BF -- */
    0x09C0, 0x0100, 0x0100, 0x0100, 0x1160, 0x05C0, 0x0100, 0x0100, 0x1160, 0x0100, 0x0990, 0x0A90,
    0x00B0, 0x00B0, 0x00B0, 0x00B0, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100,
    0x0100, 0x09B0, 0x0990, 0x1170, 0x08E0, 0x0100, 0x0C60, 0x08F0, 0x08C0, 0x05C0, 0x1160, 0x08E0,
    0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x0100, 0x1180, 0x0100, 0x0100,
    0x08F0, 0x00B0, 0x00B0, 0x1190,
...
static const SBUInt16 BranchBidiTypeIndexes[1088] = {
    ...
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0700, 0x0340, 0x0340, 0x0340, 0x0740, 0x0780, 0x07C0, 0x0800, 0x0340,
    0x0840, 0x0340, 0x0880, 0x08C0, 0x0900, 0x0940, 0x0980, 0x09C0, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x09C0,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x09C0, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x09C0, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    ...
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x09C0, 0x0A00, 0x0A40, 0x0A40, 0x0A40,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    ...
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340,
    0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x0340, 0x09C0
};
