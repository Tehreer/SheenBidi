...
static const string DATA_ARRAY_NAME = "_SBScriptPrimaryData";

static const string MAIN_INDEXES_ARRAY_TYPE = "static const SBUInt16";
static const string MAIN_INDEXES_ARRAY_NAME = "_SBScriptMainIndexes";

static const string BRANCH_INDEXES_ARRAY_TYPE = "static const SBUInt16";
static const string BRANCH_INDEXES_ARRAY_NAME = "_SBScriptBranchIndexes";
...
void ScriptLookupGenerator::generateFile(const std::string &directory) {
    ...
    lookupFunction.append("SB_INTERNAL SBScript SBScriptDetermine(SBCodepoint codepoint)").newLine();
    lookupFunction.append("{").newLine();
    lookupFunction.appendTabs(1).append("if (codepoint <= " + maxUnicode + ") {").newLine();
    lookupFunction.appendTabs(2).append("return _SBScriptPrimaryData[").newLine();
    lookupFunction.appendTabs(2).append("        _SBScriptMainIndexes[").newLine();
    lookupFunction.appendTabs(2).append("         _SBScriptBranchIndexes[").newLine();
    ...
    FileBuilder header(directory + "/SBScriptLookup.h");
    ...
    header.newLine();
    header.append("SB_INTERNAL SBScript SBScriptDetermine(SBCodepoint codepoint);").newLine();
    header.newLine();
    header.append("#endif").newLine();

    FileBuilder source(directory + "/SBScriptLookup.c");
    ...
    source.append(" */").newLine();
    source.newLine();
    source.append("#include \"SBScriptLookup.h\"").newLine();
    source.newLine();
