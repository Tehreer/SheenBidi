...
static const string DATA_ARRAY_NAME = "_SBGeneralCategoryPrimaryData";

static const string MAIN_INDEXES_ARRAY_TYPE = "static const SBUInt16";
static const string MAIN_INDEXES_ARRAY_NAME = "_SBGeneralCategoryMainIndexes";

static const string BRANCH_INDEXES_ARRAY_TYPE = "static const SBUInt16";
static const string BRANCH_INDEXES_ARRAY_NAME = "_SBGeneralCategoryBranchIndexes";
...
void GeneralCategoryLookupGenerator::generateFile(const std::string &directory) {
    ...
    FileBuilder header(directory + "/SBGeneralCategoryLookup.h");
    ...
    header.newLine();
    header.append("SB_INTERNAL SBGeneralCategory SBGeneralCategoryDetermine(SBCodepoint codepoint);").newLine();
    header.newLine();
    header.append("#endif").newLine();

    FileBuilder source(directory + "/SBGeneralCategoryLookup.c");
    ...
    source.append("SB_INTERNAL SBGeneralCategory SBGeneralCategoryDetermine(SBCodepoint codepoint) {").newLine();
    ...
    source.newLine();
    source.appendTab().append("return SBGeneralCategoryCN;").newLine();
    source.append("}").newLine();
    source.newLine();
